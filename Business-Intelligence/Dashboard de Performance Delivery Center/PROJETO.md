...
_Channels_: Informações sobre canais de venda (marketplaces).

_Deliveries_: Dados sobre as entregas realizadas.

_Drivers_: Informações sobre os entregadores parceiros.

_Hubs_: Centros de distribuição dos pedidos.

_Orders_: Vendas processadas através da plataforma (Tabela Fato).

_Payments_: Informações sobre pagamentos realizados.

_Stores_: Informações sobre os lojistas cadastrados.
